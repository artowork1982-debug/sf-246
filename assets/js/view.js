    ...
    document.addEventListener('click', function (e) {
        ...
        if (e.target.closest('.btn-reply-comment')) {
            ...
            if (form) {
                ...
                // ✅ Store parent comment ID in hidden input
                ...
                parentInput.value = commentId; // Set parent ID

                // ✅ DEBUG: Log parent ID setting
    ...
    if (footerComment) {
        footerComment.addEventListener('click', function () {
            ...
            if (form) {
                ...
                // Clear parent comment ID for new top-level comments
