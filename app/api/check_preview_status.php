...
if (!is_string($fn1) || $fn1 === '' || $fn1 === 'Array') $fn1 = null;
if (!is_string($fn2) || $fn2 === '' || $fn2 === 'Array') $fn2 = null;

$path1 = $fn1 ? (__DIR__ . '/../../uploads/previews/' . $fn1) : null;
$path2 = $fn2 ? (__DIR__ . '/../../uploads/previews/' . $fn2) : null;
...
if ($has1) {
    $response['preview_url'] = $baseUrl . '/uploads/previews/' . $fn1;
    if ($has2) {
        $response['preview_url_2'] = $baseUrl . '/uploads/previews/' . $fn2;
    }
}
